...
<script type="text/javascript"> 
	...
	function doWrite(){
		...
		$('#writeForm').attr({action:'/study2/inae/doWrite.do', method:'post'}).submit();
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Write</h2>
                    <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
                </div>
            </div>
			<!-- 시작 -->
			<form class="form-horizontal" name="writeForm" id="writeForm">
				<fieldset>
					<div class="form-group">
						<label class="col-lg-2 control-label" for="inputTitle">제 목</label>
						<div class="col-lg-10">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label" for="textContents">내 용</label>
						<div class="col-lg-10">
							<textarea class="form-control" id="textContents" name="textContents" rows="10"></textarea>
						</div>
					</div>
					<div class="form-group">
						<div class="col-lg-10 col-lg-offset-2">
							<span class="btn btn-default" type="reset">Cancel</span>
							<span class="btn btn-primary" onclick="javascript:doWrite();">Submit</span>
						</div>
					</div>
				</fieldset>
			</form>
...
<% 
    	...
    	if(null != result && !"".equals(result) && result == "success"){
    		%> 
    			<script>
    				alert("게시물이 등록되었습니다.");
    				location.href = '/study2/inae/getBoard.do';
    			</script>
