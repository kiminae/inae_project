			...
			<table class="table table-striped table-hover ">
				...
				<c:forEach var="result" items="${resultList}" varStatus="status">
					<tr>
						...
						<td><a style="color: #c9302c;" href="/study2/inae/boardDetail.do?no=${result.no}"><c:out value="${result.title}"/></a></td>
				 ...
				 <%
			  	 userId = (String)session.getAttribute("userId");
			   	 if(null != userId){
						...
						<a class="btn btn-danger" href="/study2/inae/write.do">글쓰기</a>
					</div>
			   		 <% 
			   	 } else {
			   		 %>
